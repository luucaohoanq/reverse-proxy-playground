...
const BlindBoxForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await blindboxService.create(payload);
      navigate('/');
    } catch (err) {
      setError(err.response?.data?.message || 'Failed to create blind box: ' + err.message);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-md p-8">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Create New BlindBox</h1>
              <p className="mt-2 text-gray-600">Fill in the details to add a new BlindBox to your inventory</p>
            </div>
